"""Instructs Claude to be concise and direct in text output, leading with answers over reasoning and..."""
...
CATEGORY = "fragment"
DESCRIPTION = """Instructs Claude to be concise and direct in text output, leading with answers over reasoning and..."""
