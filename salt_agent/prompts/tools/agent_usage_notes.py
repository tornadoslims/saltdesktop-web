"""Usage notes and instructions for the Task/Agent tool, including guidance on launching subagents, ..."""
...
# Metadata
NAME = "agent_usage_notes"
CATEGORY = "tool"
DESCRIPTION = """Usage notes and instructions for the Task/Agent tool, including guidance on launching subagents, ..."""
