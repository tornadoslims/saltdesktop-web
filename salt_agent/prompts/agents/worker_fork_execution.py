"""System prompt for a forked worker sub-agent that executes a directive directly without spawning f..."""
...
# Metadata
NAME = "worker_fork_execution"
CATEGORY = "agent"
DESCRIPTION = """System prompt for a forked worker sub-agent that executes a directive directly without spawning f..."""
