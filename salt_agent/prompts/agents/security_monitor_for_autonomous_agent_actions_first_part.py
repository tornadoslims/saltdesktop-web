"""Instructs Claude to act as a security monitor that evaluates autonomous coding agent actions agai..."""
...
# Metadata
NAME = "security_monitor_for_autonomous_agent_actions_first_part"
CATEGORY = "agent"
DESCRIPTION = """Instructs Claude to act as a security monitor that evaluates autonomous coding agent actions agai..."""
