"""Instructs an agent to perform a multi-phase memory consolidation pass — orienting on existing mem..."""
...
# Metadata
NAME = "dream_memory_consolidation"
CATEGORY = "agent"
DESCRIPTION = """Instructs an agent to perform a multi-phase memory consolidation pass — orienting on existing mem..."""
