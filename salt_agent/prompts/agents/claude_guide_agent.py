"""System prompt for the claude-guide agent that helps users understand and use Claude Code, the Cla..."""
...
# Metadata
NAME = "claude_guide_agent"
CATEGORY = "agent"
DESCRIPTION = """System prompt for the claude-guide agent that helps users understand and use Claude Code, the Cla..."""
