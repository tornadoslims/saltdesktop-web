"""Defines the environment context, block rules, and allow exceptions that govern which tool actions..."""
...
# Metadata
NAME = "security_monitor_for_autonomous_agent_actions_second_part"
CATEGORY = "agent"
DESCRIPTION = """Defines the environment context, block rules, and allow exceptions that govern which tool actions..."""
