"""TypeScript SDK reference including installation, client initialization, basic requests, thinking,..."""
...
# Metadata
NAME = "claude_api_reference_typescript"
CATEGORY = "data"
DESCRIPTION = """TypeScript SDK reference including installation, client initialization, basic requests, thinking,..."""
