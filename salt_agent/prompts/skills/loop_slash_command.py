"""Parses user input into an interval and prompt, converts the interval to a cron expression, and sc..."""
...
# Metadata
NAME = "loop_slash_command"
CATEGORY = "skill"
DESCRIPTION = """Parses user input into an interval and prompt, converts the interval to a cron expression, and sc..."""
