"""A comprehensive onboarding flow for setting up CLAUDE.md and related skills/hooks in the current ..."""
...
# Metadata
NAME = "init_claudemd_and_skill_setup_new_version"
CATEGORY = "skill"
DESCRIPTION = """A comprehensive onboarding flow for setting up CLAUDE.md and related skills/hooks in the current ..."""
